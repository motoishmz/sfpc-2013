...
*   Central Processing Unit (CPU)
        ...
        *   Set (Saves Data), Enable Wire, LOAD, ADD, STORE, COMPARE, JUMP IF, OUT, IN
    *   Addresses
...
The Hidden Language of Computer and Software

Chapter 18

*   Thoughout recorded history people have invented numberous clever gadgets and machines in a universal quest to make mathematical calculations just a little bit easier. #computational[T](/ep/search/?q=%23computationalrend&via=kYLqkhKJCQ0)rend
*   While the human species seemingly has an innate numerical ability, we also require frequent assitance. We can often conceive of problems that we can't easily figure solve ourselves. #createTools #mentalModels #abstraction
*   If you've designed an adding machine that does everything except the carry, you're nowhere close to being finished! #limitation
